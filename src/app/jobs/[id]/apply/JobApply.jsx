      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="bg-[#121212] border border-[#232323] p-6 rounded-2xl mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <span className="text-xs text-purple-400 font-mono tracking-wider uppercase">Applying for</span>
              <h1 className="text-xl md:text-2xl font-bold text-neutral-100">{job?.title}</h1>
              <p className="text-sm text-neutral-400">{job?.companyName} • {job?.location}</p>
            </div>
          </div>
        </div>
        ...
        <Form onSubmit={handleSubmit} className="w-full flex flex-col gap-6">
          ...
          <Card className="bg-[#121212] border border-[#232323] p-6 rounded-2xl flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <TextField isReadOnly defaultValue={applicant?.name}>
                <Label className="text-xs text-neutral-400 font-medium mb-1.5 block">Full Name</Label>
              ...
              <TextField isReadOnly defaultValue={applicant?.email}>
                <Label className="text-xs text-neutral-400 font-medium mb-1.5 block">Email Address</Label>
                <div className="relative flex items-center">
          ...
          <Card className="bg-[#121212] border border-[#232323] p-6 rounded-2xl flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <TextField>
                <Label className="text-xs text-neutral-300 font-medium mb-1.5 block">LinkedIn Profile Link (Optional)</Label>
                <div className="relative flex items-center">
              ...
              <TextField>
                <Label className="text-xs text-neutral-300 font-medium mb-1.5 block">Personal Portfolio Link (Optional)</Label>
                <div className="relative flex items-center">
              ...
              <TextField>
                ...
                <div className="relative flex items-center">
                  ...
                  <Input 
                    ...
                    onChange={(e) => handleInputChange('availableToStart', e.target.value)}
                    className="w-full bg-[#1e1e1e] border border-neutral-800 focus-within:border-neutral-600 rounded-xl pl-10 pr-3 py-2 text-sm text-neutral-200 h-10 outline-none transition-colors" 
                  />
                </div>
              </TextField>
          ...
          <Card className="bg-[#121212] border border-[#232323] p-6 rounded-2xl flex flex-col gap-6">
            ...
            <div className="w-full">
              <div className="flex justify-between items-center mb-1.5">
                <Label className="text-xs text-neutral-300 font-medium block">
                  Why should we hire you for this position? <span className="text-rose-500">*</span>
                </Label>
                <span className="text-[10px] text-neutral-500 font-mono">Required</span>
              </div>
              <TextArea
            ...
            <div className="w-full">
              <div className="flex justify-between items-center mb-1.5">
                <Label className="text-xs text-neutral-300 font-medium block">
                  Describe your best project(s) and your specific contribution (Optional)
                </Label>
              ...
              <TextArea
                ...
                onChange={(e) => handleInputChange('bestProjects', e.target.value)}
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            <Button 
              type="reset"
              onClick={() => setFormData({ resumeLink: '', experienceYears: '', availableToStart: '', githubLink: '', linkedinLink: '', portfolioLink: '', whyHireYou: '', coverLetter: '', bestProjects: '' })}
